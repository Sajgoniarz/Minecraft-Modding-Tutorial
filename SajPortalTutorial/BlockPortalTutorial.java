...
public class BlockPortalTutorial extends BlockBreakable
{
	public BlockPortalTutorial(int par1, int par2)
    {
    ...
    public static boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            for (var7 = -1; var7 <= 2; ++var7)
            {
                for (var8 = -1; var8 <= 3; ++var8)
                {
                    ...
                    if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3)
                    {
                        ...
                        else if (var10 != 0 && var10 != TutorialMainFile.BlockTutorial.blockID)
                        {
                            return false;
                        }
                    }
            ...
            for (var7 = 0; var7 < 2; ++var7)
            {
                ...
                {
                    par1World.setBlockWithNotify(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, TutorialMainFile.PortalTutorial.blockID);
                }
            }
    ...
    public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
    {
                ...
                if (entity.ridingEntity == null && entity.riddenByEntity == null && entity instanceof EntityPlayerMP)
                {
                        if (entity instanceof EntityPlayerMP)
                        {
                                ...
                                {
                                        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 2 , new TeleporterTutorial(thePlayer.mcServer.worldServerForDimension(2)));
                                }
                                else
                                {
