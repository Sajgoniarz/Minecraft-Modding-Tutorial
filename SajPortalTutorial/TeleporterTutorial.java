...
{
if (this.field_85192_a.getBlockId(var48, var26, var23) == TutorialMainFile.BlockTutorial.blockID)
{
while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == TutorialMainFile.BlockTutorial.blockID)
{
--var26;
}
...
if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == TutorialMainFile.PortalTutorial.blockID)
{
var50 = 2;
}
...
if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == TutorialMainFile.PortalTutorial.blockID)
{
var50 = 3;
}
...
this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? Block.sandStone.blockID : TutorialMainFile.PortalTutorial.blockID);
}
}
